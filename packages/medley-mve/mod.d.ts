/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Types/TypeRepository.ts" />
...
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Models/ModelRepository.ts" />
...
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Models/index.ts" />
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Composition.ts" />
export interface Composition {
  types: URL | TypeTree;
  modelsByType: ModelsOfType[];
}
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Types/index.ts" />
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Core/ViewEngine.ts" />
...
export declare class ViewEngine {
  ...
  constructor(
    getModel: (modelId: string) => Promise<Typed>,
    getViewFunction: (typeId: string) => Promise<ViewFunction>,
  );
  renderModel<T>(modelId: string, ...args: any[]): Promise<T>;
}
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Core/Typed.ts" />
export interface Typed {
  typeId: string;
}
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Core/index.ts" />
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Models/Model.ts" />
...
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/ModelViewEngine.ts" />
export declare class ModelViewEngine {
  private viewEngine;
  constructor(compositionRepo: CompositionRepository);
  renderModel<T>(modelId: string, args: any[]): Promise<T>;
}
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/CompositionRepository.ts" />
...
/// <amd-module name="file:///C:/Dev/medley/packages/medley-mve/src/Types/Type.ts" />
