...
import { CLink, CNode, constants, CType, GetNodeEditComponent } from "@medley-js/common";
...
export const Edit = componentStory(
  async () => {
    ...
    const id_2 = childScope.nodes.upsertNode({name:"IDENTITY_2", position:{x:500,y:50}, type: IdentityType.name})
    const id_3 = childScope.nodes.upsertNode({name:"IDENTITY_3", position:{x:1050,y:300}, type: IdentityType.name})
